      ...
      <div class="container text-center">
        ...
        <div class="row h-100">
          <div class="col-lg-8 mx-auto align-self-center">
            ...
            <p class="opacity-70 text-uppercase small ls-1">{{ $post->catagory->name }}</p>
...
var disqus_config = function () {
    this.page.url ="http://localhost/blog/posts/{{$post->id}}" ;  // Replace PAGE_URL with your page's canonical URL variable
